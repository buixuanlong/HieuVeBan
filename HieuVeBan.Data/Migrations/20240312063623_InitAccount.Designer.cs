...
namespace HieuVeBan.Data.Migrations
{
    ...
    [Migration("20240312063623_InitAccount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.EducationProgram", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("EducationProgramTypeId")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("education_programs", "dbo");
                });

            modelBuilder.Entity("HieuVeBan.Models.Entities.EducationProgramType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("education_program_types", "dbo");
                });
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.UserHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.Account", b =>
                {
                    b.HasOne("HieuVeBan.Models.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.EducationProgram", b =>
                {
                    b.HasOne("HieuVeBan.Models.Entities.EducationProgramType", "EducationProgramType")
                        .WithMany()
                        .HasForeignKey("EducationProgramTypeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("EducationProgramType");
                });
            ...
            modelBuilder.Entity("HieuVeBan.Models.Entities.UserHistory", b =>
                {
                    ...
                    b.HasOne("HieuVeBan.Models.Entities.User", "User")
                        .WithMany()
